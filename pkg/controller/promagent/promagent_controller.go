...
var log = logf.Log.WithName("controller_promagent")
...
func newReconciler(mgr manager.Manager) reconcile.Reconciler {
	return &ReconcilePromagent{client: mgr.GetClient(), scheme: mgr.GetScheme()}
}
...
func (r *ReconcilePromagent) Reconcile(request reconcile.Request) (reconcile.Result, error) {
	...
	// Fetch the Promagent instance
	instance := &promagentv1alpha1.Promagent{}
	...
	// Set Promagent instance as the owner and controller
...
func newPodForCR(cr *promagentv1alpha1.Promagent) *corev1.Pod {
